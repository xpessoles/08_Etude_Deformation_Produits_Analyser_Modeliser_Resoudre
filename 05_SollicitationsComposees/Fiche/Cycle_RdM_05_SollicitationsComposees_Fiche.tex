...
\usepackage[%
    pdftitle={Résistance des matériaux : Modélisation des pièces déformables - Sollicitations composées},
...
\def\xxchapitre{\hspace{.12cm} Sollicitations composées}
...
Sollicitations composées -- \xxactivite%
}
